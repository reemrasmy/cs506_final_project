...
expression_df = process_expression_data("data/TCGA.BRCA.sampleMap_HiSeqV2")
clinical_metadata = process_clinical_metadata("data/TCGA.BRCA.sampleMap_BRCA_clinicalMatrix")
merged_expr = merge_expression_metadata(expression_df, clinical_metadata)           # print(merged_expr.shape)      # (821, 20532)
print(merged_expr.max())

merged_expr.to_csv("data/processed_brca_data.csv")
